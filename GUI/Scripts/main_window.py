...
class Ui_ClearMod_Window(object):
    def setupUi(self, ClearMod_Window):
        ...
        self.Menu_widget = VerticalTabWidget()
        self.Menu_widget.setTabPosition(QtWidgets.QTabWidget.West)
        ...
        self.CMStart_groupBox = QtWidgets.QGroupBox(self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.CMStart_groupBox.sizePolicy().hasHeightForWidth())
        self.CMStart_groupBox.setSizePolicy(sizePolicy)
        self.CMStart_groupBox.setMinimumSize(QtCore.QSize(0, 150))
        self.CMStart_groupBox.setObjectName("CMStart_groupBox")
        self.gridLayout_14 = QtWidgets.QGridLayout(self.CMStart_groupBox)
        self.gridLayout_14.setObjectName("gridLayout_14")
        self.Start_layout = QtWidgets.QVBoxLayout()
        self.Start_layout.setObjectName("Start_layout")
        self.start_label = QtWidgets.QLabel(self.CMStart_groupBox)
        self.start_label.setObjectName("start_label")
        self.Start_layout.addWidget(self.start_label)
        self.LighTheam_radioButton = QtWidgets.QRadioButton(self.CMStart_groupBox)
        ...
        self.DarkTheam_radioButton = QtWidgets.QRadioButton(self.CMStart_groupBox)
        self.DarkTheam_radioButton.setObjectName("DarkTheam_radioButton")
        self.Start_layout.addWidget(self.DarkTheam_radioButton)
        self.reboot_checkBox = QtWidgets.QCheckBox(self.CMStart_groupBox)
        self.reboot_checkBox.setObjectName("reboot_checkBox")
        self.Start_layout.addWidget(self.reboot_checkBox)
        self.Start_button = QtWidgets.QPushButton(self.CMStart_groupBox)
        self.Start_button.setObjectName("Start_button")
        self.Start_layout.addWidget(self.Start_button)
        self.gridLayout_14.addLayout(self.Start_layout, 0, 0, 1, 1)
        self.verticalLayout_13.addWidget(self.CMStart_groupBox)
        self.Additionally_groupBox = QtWidgets.QGroupBox(self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Additionally_groupBox.sizePolicy().hasHeightForWidth())
        self.Additionally_groupBox.setSizePolicy(sizePolicy)
        self.Additionally_groupBox.setMinimumSize(QtCore.QSize(0, 200))
        self.Additionally_groupBox.setObjectName("Additionally_groupBox")
        self.gridLayout_15 = QtWidgets.QGridLayout(self.Additionally_groupBox)
        self.gridLayout_15.setObjectName("gridLayout_15")
        self.Additionally_buttons = QtWidgets.QTabWidget(self.Additionally_groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Additionally_buttons.sizePolicy().hasHeightForWidth())
        self.Additionally_buttons.setSizePolicy(sizePolicy)
        self.Additionally_buttons.setMaximumSize(QtCore.QSize(16777215, 200))
        self.Additionally_buttons.setObjectName("Additionally_buttons")
        self.tab_9 = QtWidgets.QWidget()
        self.tab_9.setObjectName("tab_9")
        self.gridLayout_16 = QtWidgets.QGridLayout(self.tab_9)
        self.gridLayout_16.setObjectName("gridLayout_16")
        self.ShortcutCreate_button = QtWidgets.QPushButton(self.tab_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ShortcutCreate_button.sizePolicy().hasHeightForWidth())
        self.ShortcutCreate_button.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.ShortcutCreate_button.setFont(font)
        self.ShortcutCreate_button.setObjectName("ShortcutCreate_button")
        self.gridLayout_16.addWidget(self.ShortcutCreate_button, 0, 0, 1, 1)
        self.ShortcutDelete_button = QtWidgets.QPushButton(self.tab_9)
        self.ShortcutDelete_button.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ShortcutDelete_button.sizePolicy().hasHeightForWidth())
        self.ShortcutDelete_button.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.ShortcutDelete_button.setFont(font)
        self.ShortcutDelete_button.setObjectName("ShortcutDelete_button")
        self.gridLayout_16.addWidget(self.ShortcutDelete_button, 1, 0, 1, 1)
        self.Additionally_buttons.addTab(self.tab_9, "")
        self.tab_10 = QtWidgets.QWidget()
        self.tab_10.setObjectName("tab_10")
        self.gridLayout_17 = QtWidgets.QGridLayout(self.tab_10)
        self.gridLayout_17.setObjectName("gridLayout_17")
        self.Uninstall_button = QtWidgets.QPushButton(self.tab_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ClearAppdata_button.sizePolicy().hasHeightForWidth())
        self.ClearAppdata_button.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.Menu_widget.addTab(self.tab_3, "")
        self.tab_6 = QtWidgets.QWidget()
        self.tab_6.setObjectName("tab_6")
        self.layoutWidget = QtWidgets.QWidget(self.tab_6)
        self.layoutWidget.setGeometry(QtCore.QRect(11, 2, 461, 217))
        self.layoutWidget.setObjectName("layoutWidget")
        self.verticalLayout_12 = QtWidgets.QVBoxLayout(self.layoutWidget)
        self.verticalLayout_12.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.Login_groupBox_1 = QtWidgets.QGroupBox(self.layoutWidget)
        ...
        self.Login_groupBox_2 = QtWidgets.QGroupBox(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.ClearData_button_2 = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.LoginError_label = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.Menu_widget.addTab(self.tab_6, "")
        ...
        self.Menu_widget.addTab(self.tab_2, "")
        ...
        self.gridLayout_10.addWidget(self.ReloadItems_button, 1, 0, 1, 1)
        ...
        self.Menu_widget.addTab(self.tab_4, "")
        self.widget1 = QtWidgets.QWidget()
        self.widget1.setObjectName("widget1")
        self.gridLayout_11 = QtWidgets.QGridLayout(self.widget1)
        self.gridLayout_11.setObjectName("gridLayout_11")
        self.Contacts_widget = QtWidgets.QTabWidget(self.widget1)
        self.Contacts_widget.setObjectName("Contacts_widget")
        self.tab_7 = QtWidgets.QWidget()
        self.tab_7.setObjectName("tab_7")
        self.gridLayout_12 = QtWidgets.QGridLayout(self.tab_7)
        self.gridLayout_12.setObjectName("gridLayout_12")
        self.telegram_url = QtWebEngineWidgets.QWebEngineView(self.tab_7)
        self.telegram_url.setUrl(QtCore.QUrl("https://t.me/clrmod"))
        self.telegram_url.setObjectName("telegram_url")
        self.gridLayout_12.addWidget(self.telegram_url, 0, 0, 1, 1)
        self.ReloadContacts_button = QtWidgets.QPushButton(self.tab_7)
        self.ReloadContacts_button.setObjectName("ReloadContacts_button")
        self.gridLayout_12.addWidget(self.ReloadContacts_button, 1, 0, 1, 1)
        self.Contacts_widget.addTab(self.tab_7, "")
        ...
        self.gridLayout_11.addWidget(self.Contacts_widget, 1, 0, 1, 1)
        self.Menu_widget.addTab(self.widget1, "")
    ...
    def retranslateUi(self, ClearMod_Window):
        ...
        self.CMStart_groupBox.setTitle(_translate("ClearMod_Window", "Запуск Clear Mod"))
        ...
        self.Menu_widget.setTabText(self.Menu_widget.indexOf(self.tab_3), _translate("ClearMod_Window", "Регистрация"))
        ...
        self.Menu_widget.setTabText(self.Menu_widget.indexOf(self.tab_6), _translate("ClearMod_Window", "Авторизация"))
        ...
        self.Menu_widget.setTabText(self.Menu_widget.indexOf(self.tab_2), _translate("ClearMod_Window", "Система"))
