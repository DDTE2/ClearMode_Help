...
class Ui_ClearMod_Window(object):
    def setupUi(self, ClearMod_Window):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 0, 571, 401))
        ...
        self.gridLayout_15.addWidget(self.Additionally_buttons, 2, 0, 1, 1)
        ...
        self.ReloadContacts_button = QtWidgets.QPushButton(self.widget1)
        self.ReloadContacts_button.setObjectName("ReloadContacts_button")
        self.gridLayout_11.addWidget(self.ReloadContacts_button, 0, 0, 1, 1)
