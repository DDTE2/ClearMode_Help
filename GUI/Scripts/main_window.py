...
class Ui_ClearMode_Window(object):
    def setupUi(self, ClearMode_Window):
        ClearMode_Window.setObjectName("ClearMode_Window")
        ClearMode_Window.resize(920, 615)
        ClearMode_Window.setMinimumSize(QtCore.QSize(920, 615))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Icons/ClearMod.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ClearMode_Window.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(ClearMode_Window)
        ...
        self.CheckData_button_2 = QtWidgets.QPushButton(self.RegButtons_groupBox)
        self.CheckData_button_2.setObjectName("CheckData_button_2")
        self.horizontalLayout_7.addWidget(self.CheckData_button_2)
        self.Reg_button_2 = QtWidgets.QPushButton(self.RegButtons_groupBox)
        self.Reg_button_2.setObjectName("Reg_button_2")
        self.horizontalLayout_7.addWidget(self.Reg_button_2)
        ...
        ClearMode_Window.setCentralWidget(self.centralwidget)

        self.retranslateUi(ClearMode_Window)
        ...
        QtCore.QMetaObject.connectSlotsByName(ClearMode_Window)

    def retranslateUi(self, ClearMode_Window):
        _translate = QtCore.QCoreApplication.translate
        ClearMode_Window.setWindowTitle(_translate("ClearMode_Window", "ClearMode"))
        self.start_label.setText(_translate("ClearMode_Window", "Выберите способ запуска"))
        self.LighTheam_radioButton.setText(_translate("ClearMode_Window", "Светлая тема"))
        self.DarkTheam_radioButton.setText(_translate("ClearMode_Window", "Тёмная тема"))
        self.reboot_checkBox.setText(_translate("ClearMode_Window", "Снять перманентный бан и перезагрузить компьютер"))
        self.Start_button.setText(_translate("ClearMode_Window", "Старт"))
        self.Interface_Widget.setTabText(self.Interface_Widget.indexOf(self.tab), _translate("ClearMode_Window", "Clear Mode"))
        self.Data_box.setTitle(_translate("ClearMode_Window", "Данные"))
        self.Login_label.setText(_translate("ClearMode_Window", "Имя"))
        self.Password_label.setText(_translate("ClearMode_Window", "Пароль"))
        self.Referal_label.setText(_translate("ClearMode_Window", "Ник пригласившего пользователя"))
        self.ShowPassword_checkBox.setText(_translate("ClearMode_Window", "Показывать пароль"))
        self.Avatar_groupBox.setTitle(_translate("ClearMode_Window", "Аватар"))
        self.LeftPublicAvatar_button.setText(_translate("ClearMode_Window", "..."))
        self.PublicAvatar_image.setText(_translate("ClearMode_Window", "<html><head/><body><p align=\"center\"><img src=\":/Public/Public/8.png\"/></p></body></html>"))
        self.RightPublicAvatar_button.setText(_translate("ClearMode_Window", "..."))
        self.Avatar_widget.setTabText(self.Avatar_widget.indexOf(self.widget), _translate("ClearMode_Window", "Общедоступные образы"))
        self.LeftSecretAvatar_button.setText(_translate("ClearMode_Window", "..."))
        self.SecretAvatar_image.setText(_translate("ClearMode_Window", "<html><head/><body><p align=\"center\"><img src=\":/Secret/Secret/0.png\"/></p></body></html>"))
        self.RightSecretAvatar_button.setText(_translate("ClearMode_Window", "..."))
        self.Avatar_widget.setTabText(self.Avatar_widget.indexOf(self.tab_5), _translate("ClearMode_Window", "Прочие образы"))
        self.UserGen_button.setText(_translate("ClearMode_Window", "Сгенерировать случайного пользователя"))
        self.ClearData_button.setText(_translate("ClearMode_Window", "Отчистить"))
        self.RegButtons_groupBox.setTitle(_translate("ClearMode_Window", "Регистрация"))
        self.CheckData_button_2.setText(_translate("ClearMode_Window", "Проверить данные"))
        self.Reg_button_2.setText(_translate("ClearMode_Window", "Зарегистрироваться"))
        self.Interface_Widget.setTabText(self.Interface_Widget.indexOf(self.tab_3), _translate("ClearMode_Window", "Регистрация"))
        self.Login_label_2.setText(_translate("ClearMode_Window", "Имя"))
        self.Password_label_2.setText(_translate("ClearMode_Window", "Пароль"))
        self.ShowPassword2_checkBox.setText(_translate("ClearMode_Window", "Показывать пароль"))
        self.pushButton.setText(_translate("ClearMode_Window", "Войти"))
        self.Interface_Widget.setTabText(self.Interface_Widget.indexOf(self.tab_6), _translate("ClearMode_Window", "Авторизация"))
        self.System_groupBox.setTitle(_translate("ClearMode_Window", "Система"))
        self.OS_label.setText(_translate("ClearMode_Window", "Операционная система:"))
        self.MAC_label.setText(_translate("ClearMode_Window", "MAC-адрес:"))
        self.IP_label.setText(_translate("ClearMode_Window", "IP-адрес:"))
        self.ShowSystemData_checkBox.setText(_translate("ClearMode_Window", "Скрыть данные"))
        self.Launchers_groupBox.setTitle(_translate("ClearMode_Window", "Лаунчеры шарарама"))
        self.ClearMode_label.setText(_translate("ClearMode_Window", "Clear Mode:"))
        self.Shararam_label.setText(_translate("ClearMode_Window", "Официальный лаунчер шарарама"))
        self.Private_label.setText(_translate("ClearMode_Window", "Приватки:"))
        self.ClearMode_value_label.setText(_translate("ClearMode_Window", "Установлен"))
        self.Software_groupBox.setTitle(_translate("ClearMode_Window", "Специальное ПО"))
        self.VPN_label.setText(_translate("ClearMode_Window", "VPN:"))
        self.WPE_label.setText(_translate("ClearMode_Window", "WPE PRO:"))
        self.Wireshark_label.setText(_translate("ClearMode_Window", "Wireshark:"))
        self.Charles_label.setText(_translate("ClearMode_Window", "Charles Proxy:"))
        self.Fiddler_label.setText(_translate("ClearMode_Window", "Fiddler:"))
        self.Interface_Widget.setTabText(self.Interface_Widget.indexOf(self.tab_2), _translate("ClearMode_Window", "Система"))
        self.Interface_Widget.setTabText(self.Interface_Widget.indexOf(self.tab_4), _translate("ClearMode_Window", "Список вещей"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ClearMode_Window = QtWidgets.QMainWindow()
    ui = Ui_ClearMode_Window()
    ui.setupUi(ClearMode_Window)
    ClearMode_Window.show()
    sys.exit(app.exec_())
